...
export default function Navbar({ pdfCount = 0, logCount = 0 }: NavbarProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center space-x-2">
            <span className="text-lg font-medium text-gray-900">Care</span>
          </Link>
        ...
        {/* Mobile Navigation */}
        <div id="mobile-menu" className="hidden md:hidden border-t border-gray-200 py-4">
